...
/**
 * Created by nomasp on 2016/05/16.
 */
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalHeight = a.getDimension(
                    R.styleable.AvatarImageBehavior_finalHeight, 0);
            a.recycle();
        }
    }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent,
        ...
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            float heightFactor = (mChangeBehaviorPoint - expandedPercentageFactor)
            ...
            float heightToSubtract = ((mStartHeight - mCustomFinalHeight) *
                    heightFactor);
